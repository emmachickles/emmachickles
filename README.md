...
> 📣 **News (2026):** *Template Matching, Not Time Learning* accepted at the **AI4Physics workshop @ ICML 2026** — [code & paper »](https://github.com/emmachickles/period-diagnostic)
...
- **Chickles, E.** & Audenaert, J. *"Template Matching, Not Time Learning: A Diagnostic for Self-Supervised Light-Curve Encoders"* — *AI4Physics Workshop, ICML* (2026) · [code & paper](https://github.com/emmachickles/period-diagnostic) · [poster](https://github.com/emmachickles/period-diagnostic/blob/main/poster/poster.pdf)
